  ...
  render() {
    ...
    return (
      <div className='collapsible-sliding-panel-main-content'>
        <div id='collapsible-sliding-panel-expander'
             title={this.state.collapsiblePanelOpen ? i18n(COLLAPSE) : i18n(EXPAND)}
             className={expanderClassName}
             onClick={() => this.onExpandToggle(this.props.collapseCallback)}></div>
